  ...
  return (
    <header className="flex h-16 items-center  justify-around border-b border-zinc-200 bg-zinc-50 font-sans dark:border-zinc-800 dark:bg-black">
      ...
      <ul className="flex space-x-4">
        ...
        {/* <li><Link href="/clientcomponent" className="hover:underline">clientcomponent</Link></li>
        <li><Link href="/servercomponent" className="hover:underline">servercomponent</Link></li> */}
      </ul>
    </header>
  );
}
